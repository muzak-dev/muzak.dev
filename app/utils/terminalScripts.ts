...
export const TERMINAL_SCRIPTS: Record<string, TermStep[]> = {
  install: [
    ...
    { out: 'go: downloading muzak.dev/framework v0.1.1', cls: 'c-faint', d: 280 },
    { out: 'go: added muzak.dev/framework v0.1.1', cls: 'c-ash', d: 240 },
  ...
  get: [
    ...
    { cmd: 'go get muzak.dev/framework' },
    { html: '<span class="c-patina">✓</span> <span class="c-ash">added</span> <span class="c-bone">muzak.dev/framework v0.1.1</span>', d: 120 },
  ],
  layout: [
